...
from MultiGAN_impute_st import scMultiGAN_impute
import imputer_old
...
parser.add_argument('--c_file', type=str, default='../demo_datadataset12_st_label.txt', help='path of cls file')
parser.add_argument('--coords_file', type=str, default='../demo_datadataset12_coords.csv', help='path of cls file')
parser.add_argument('--channels', type=int, default=1, help='number of image channels')
parser.add_argument('--img_size', type=int, default=6, help='size of each image dimension')
parser.add_argument('--imputeronly', action='store_false',default = True)
parser.add_argument('--imputer_model', type=str,default="../dataset12_st_one/model_impute/0499_12_1.pth",help='path of pretrain model')
parser.add_argument('--output_dir',type=str,default='../dataset12_st_one',help='path of the project')
parser.add_argument('--checkpoint',type=str,default=None,help='path of the output_checkpoint')
parser.add_argument('--lr',type=int,default=1e-5,help='Learnsing rate')  
parser.add_argument('--ncls', type=int, default=14, help='number of clusters')  
...
ad_res = sc.read("/mnt/datab/home/zhaohui/WBT/scMultiGAN/dataset2/dataset12_spatial_1000.h5ad")
...
if(opt.imputeronly):
    ...
    scMultiGAN_impute(opt, imputer_2, imputer_1, impu_critic_st, impu_critic_sc, dataloader)  
...
for j,real_sample in enumerate(dataloader):
    ...
    impu_noise.normal_()
    impute_data = imputer_2(real_data, real_mask, impu_noise,label_hot,cord) 
...
result.to_csv(Path(os.path.join(opt.output_dir,'imputed_data',"scMultiGAN_fold_5.csv")) ,index=False)
