...
adata = sc.read_h5ad('./result/Merfish/mop/Spatial_MGCN.h5ad')
print(adata.obs)
savepath = './result/Merfish/mop/Denoise/'

if not os.path.exists(savepath):
    os.mkdir(savepath)


marker_genes = ['Cux2', 'Otof', 'Rorb', 'Rspo1', 'Sulf2', 'Fezf2', 'Osr1']#, 'NTNG2'
#marker_genes = [_.lower() for _ in marker_genes]
print(marker_genes)
...
for gene in marker_genes:
    ...
    if np.isin(gene, np.array(adata.var.index.values)):
        print("plot figure")
